...
export class EventService {
  ...
  // This method returns static events data from Events array
  ...
  // This method talks with little server over http and returns Events data
  getEvents(): Observable<IEvent[]> {
    return this.http
